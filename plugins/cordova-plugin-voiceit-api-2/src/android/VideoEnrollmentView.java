...
//        setContentView(R.layout.activity_video_enrollment_view);
        setContentView(getResources().getIdentifier("activity_video_enrollment_view", "layout", getPackageName()));
                                                ...
                                                public void onSuccess(int statusCode, Header[] headers, final JSONObject response) {
                                                    ...
                                                    try {
                                                      if (!response.getString("text").toLowerCase().equals(phrase.toLowerCase())) {
                                                            ...
                                                            overlay.updateDisplayText(getString(getResources().getIdentifier("ENROLL_FAIL", "string", getPackageName())));
                                                            ...
                                                            overlay.updateDisplayText(getString(getResources().getIdentifier("ENROLL_SUCCESS", "string", getPackageName())));
                                                            ...
                                                            new CountDownTimer(2000, 1000) {
                                                                ...
                                                                public void onFinish() {
                                                                    ...
                                                                    if (enrollmentCount >= neededEnrollments) {
                                                                        overlay.updateDisplayText(getString(getResources().getIdentifier("ALL_ENROLL_SUCCESS", "string", getPackageName())));
