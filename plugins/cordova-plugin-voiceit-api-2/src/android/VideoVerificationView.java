...
public class VideoVerificationView extends AppCompatActivity {
    ...
    private String themeColor = "#FBC132";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(getResources().getIdentifier("VoiceItTheme", "style", getPackageName()));
        ...
        if(bundle != null) {
            this.themeColor = bundle.getString("themeColor");
        ...
        mContext = this;
        // Set content view
        setContentView(getResources().getIdentifier("activity_video_verification_view", "layout", getPackageName()));
        ...
        overlay = findViewById(getResources().getIdentifier("overlay", "id", getPackageName()));
                ...
                if(!isRecording) {
                    if (faces.length == 1) {
                        ...
                        verifyUser();
                         ...
                         overlay.updateDisplayText(getString(getResources().getIdentifier("TOO_MANY_FACES", "string", getPackageName())));
                         overlay.setProgressCircleAngle(0);
                    } else {
                        // Log.d("FaceDetection", "No face present");
                        // Tell user there is no face in camera preview
                        overlay.updateDisplayText(getString(getResources().getIdentifier("LOOK_INTO_CAM", "string", getPackageName())));
                        overlay.setProgressCircleAngle(0);
                    }
                }
            }
        ...
        if (checkCameraHardware(this)) {
            try {
                ...
                if (mCamera != null) {
                    ...
                    FrameLayout preview = findViewById(getResources().getIdentifier("camera_preview", "id", getPackageName()));
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            new CountDownTimer(1000, 1000) {
                ...
                public void onFinish() {
                    overlay.updateDisplayText(getString(getResources().getIdentifier("SAY_PASSPHRASE", "string", getPackageName())));
                    ...
                    new CountDownTimer(100, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            try {
                                ...
                                overlay.setProgressCircleColor(themeColor);
                                ...
                                new CountDownTimer(4800, 4800) {
                                    ...
                                    public void onFinish() {
                                        try {
                                            ...
                                            overlay.updateDisplayText(getString(getResources().getIdentifier("WAIT", "string", getPackageName())));
                                                ...
                                                public void onSuccess(int statusCode, Header[] headers, final JSONObject response) {
                                                    ...
                                                    try {
                                                         if (!response.getString("text").toLowerCase().equals(phrase.toLowerCase())) {
                                                            overlay.setProgressCircleColor("#c0392b");
                                                            overlay.updateDisplayText(getString(getResources().getIdentifier("VERIFY_FAIL", "string", getPackageName())));
                                                            ...
                                                            new CountDownTimer(1500, 10) {
                                                                ...
                                                                public void onFinish() {
                                                                    ...
                                                                    overlay.updateDisplayText(getString(getResources().getIdentifier("INCORRECT_PASSPHRASE", "string", getPackageName())));
                                                                    ...
                                                                    if(failedAttempts > maxFailedAttempts) {
                                                                        overlay.updateDisplayText(getString(getResources().getIdentifier("TOO_MANY_ATTEMPTS", "string", getPackageName())));
                                                            ...
                                                            overlay.setProgressCircleColor("#27ae60");
                                                            overlay.updateDisplayText(getString(getResources().getIdentifier("VERIFY_SUCCESS", "string", getPackageName())));
            ...
            public void onSuccess(int statusCode, Header[] headers, final JSONObject response) {
                ...
                try {
                    ...
                    if(enrollmentCount < neededEnrollments) {
                        overlay.updateDisplayText(getString(getResources().getIdentifier("NOT_ENOUGH_ENROLLMENTS", "string", getPackageName())));
