...
function doVoiceEnrollment(){
  ...
  var phrase = 'My face and voice identify me';
  ...
  app.myVoiceIt.createVoiceEnrollment({
    ...
    contentLanguage : 'en-US'}, function(jsonResponse){
...
var app = {
    ...
    onDeviceReady: function() {
        ...
        app.myVoiceIt = new VoiceItAPITwo({ apiKey : 'key_4306d632525748ac987cc0385ceff339', apiToken: 'tok_c910f4047d1d425980c856bb3ca8fa5b', themeColor: '#8e44ad'});
        app.currentUserId = "";
