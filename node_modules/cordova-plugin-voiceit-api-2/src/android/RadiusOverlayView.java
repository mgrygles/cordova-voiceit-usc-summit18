...
public class RadiusOverlayView extends LinearLayout {
    ...
    private String progressCircleColor = "#000000";
    ...
    public void setProgressCircleColor(String colorHex){
        progressCircleColor = colorHex;
        this.invalidate();
    }
    ...
    protected void createWindowFrame() {
        ...
        invertedCirclePaint.setColor(Color.BLACK); // This is the color of the activity background
        ...
        progressCirclePaint.setColor(Color.parseColor(progressCircleColor));
